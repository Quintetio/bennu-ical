...
$ev->add_property('attach', base64_encode('Application-Data-Octets'), ['fmttype' => 'application/octet-stream', 'encoding' => 'BASe64', 'value' => 'binARY']);
...
$ev->add_property('resources', ['one of this', 'one of that']);

// Start-end date
$ev->add_property('class', 'PRIVATE');
$ev->add_property('dtstart', '20050623', ['value' => 'DATE']);
$ev->add_property('dtend', '20050624', ['value' => 'DATE']);
$ev->add_property('dtstamp', '20050622T235601Z');

$ev->add_property('attendee', 'mailto:pj@uom.gr', ['cn' => 'John Papaioannou', 'delegated-from' => ['mailto:bla@some.net', 'mailto:bla@some.net']]);
